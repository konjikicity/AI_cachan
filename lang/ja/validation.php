...
return [
    ...
    "gt.array" => ":Attributeの項目数は、:value個より多くなければいけません。",
    "gt.file" => ":Attributeは、:value KBより大きくなければいけません。",
    "gt.numeric" => ":Attributeは、:valueより大きくなければいけません。",
    "gt.string" => ":Attributeは、:value文字より大きくなければいけません",
    "gte.array" => ":Attributeの項目数は、:value個以上でなければいけません。",
    "gte.file" => ":Attributeは、:value KB以上でなければいけません。",
    "gte.numeric" => ":Attributeは、:value以上でなければいけません。",
    "gte.string" => ":Attributeは、:value文字以上でなければいけません。",
    ...
    "lt.array" => ":Attributeの項目数は、:value個より少なくなければいけません。",
    "lt.file" => ":Attributeは、:value KBより小さくなければいけません。",
    "lt.numeric" => ":Attributeは、:valueより小さくなければいけません。",
    "lt.string" => ":Attributeは、:value文字より小さくなければいけません。",
    "lte.array" => ":Attributeの項目数は、:value個以下でなければいけません。",
    "lte.file" => ":Attributeは、:value KB以下でなければいけません。",
    "lte.numeric" => ":Attributeは、:value以下でなければいけません。",
    "lte.string" => ":Attributeは、:value文字以下でなければいけません。",
    "mac_address" => ":Attributeは有効なMACアドレスである必要があります。",
    "max.array" => ":Attributeの項目数は、:max個以下でなければいけません。",
    "max.file" => ":Attributeは、:max KB以下のファイルでなければいけません。",
    "max.numeric" => ":Attributeは、:max以下の数字でなければいけません。",
    "max.string" => ":Attributeの文字数は、:max文字以下でなければいけません。",
    ...
    "min.string" => ":Attributeの文字数は、:min文字以上でなければいけません。",
